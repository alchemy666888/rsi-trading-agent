# Monthly Paper Trading Report: 2023-11

- Total Return: -0.07%
- Sharpe: -0.3142
- Max Drawdown: 0.72%
- Win Rate: 33.33%
- Profit Factor: 0.8679
- Expectancy: -0.01%
- Trade Count: 6
- Reliability Flags: low_sample_size, one_sided_exposure, negative_sharpe, profit_factor_below_one, negative_total_return

## Lesson Learned

Loss-making month with weak trade quality. Reduce countertrend short exposure, prefer bull-regime long breakout or continuation setups over shallow pullbacks, and trim news-driven signal amplification unless timestamp confidence is high.
